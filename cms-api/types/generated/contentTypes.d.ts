...
export interface AdminApiToken extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    kind: Schema.Attribute.Enumeration<['content-api', 'admin']> & Schema.Attribute.Required & Schema.Attribute.DefaultTo<'content-api'>;
...
export interface ApiDynamicPageDynamicPage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    blocks: Schema.Attribute.DynamicZone<
      ['article.masonry-list', 'shared.hero-slider', 'article.slideset-list', 'shared.seperator', 'shared.widget', 'shared.widget-grid']
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
    locale: Schema.Attribute.String;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::dynamic-page.dynamic-page'>;
    publishedAt: Schema.Attribute.DateTime;
    seo: Schema.Attribute.Component<'shared.seo', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
